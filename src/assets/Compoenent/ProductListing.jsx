            ...
            <div class="card shadow-sm d-none d-lg-block">
              <div class="card-body">
                ...
                <div class="mb-4  category_scroll">
                  ...
                  </div> */}
                  {
                    ...
                    category.length > 0
                      ...
                      category.map((v, i) => {
                        return (
                          <DisplayCategory key={i} categories={v} fileterChange={fileterChange}/>
                ...
                <div class="mb-4  category_scroll">
                  <h6 class="fw-bold mb-3">Brands</h6>
                  {
                    brand.length > 0
                      ...
                      brand.map((v, i) => {
                        return (
                          <DisplayBrand key={i} brand={v} fileterChange={fileterChange}  />
                        )
                      })
                ...
                <div class="mb-3">
                  ...
                  <input type="range" onChange={ranger} class="form-range" min="0" max="100000" step="1000" id='priceRange' />
                  <div class="row g-2 mt-2">
                    <div class="col-6">
                      <div class="input-group input-group-sm">
                        <span class="input-group-text">$</span>
                        <input type="number" class="form-control" placeholder="Min" min="0" onChange={pricefilter} />
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="input-group input-group-sm">
                        <span class="input-group-text">$</span>
                        <input type="number" class="form-control" placeholder="Max" min="0" onChange={priceTill}/>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-body">
                <div class="row align-items-center">
                  <div class="col-md-6 mb-2 mb-md-0">
                    <h6 class="mb-0  align-items-center">{product.length} Product are Here</h6>
                  ...
                  <div class="col-md-6">
                    <div class="d-flex align-items-center justify-content-md-end">
                      ...
                      <select class="form-select form-select-sm w-auto" onChange={filterProduct}>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
              {
                product.length > 0
                  ...
                  product.map((v, i) => {
                    return (
                      <ProductCart key={i} product={v} fileterChange={fileterChange} />
                    )
                  })
                  :
                  ''
...
function DisplayCategory({ categories, fileterChange}) {
  return (
    <div class="form-check mb-2">
      <input class="form-check-input" type="checkbox" id={`${'cate_' + categories.id}`}  onClick={ ()=>fileterChange(categories.slug)}/>
      <label class="form-check-label" for={`${'cate_' + categories.id}`} >{categories.name}</label>
    </div>
  )
}
