                          ...
                          <div class="d-flex justify-content-between">
                            <div>
                              <select class="form-select">
                                <option
                                  value="1"
                                  selected={v.quantity == 1 ? "selected" : ""}
                                >
                                  1
                                </option>
                                <option
                                  value="2"
                                  selected={v.quantity == 2 ? "selected" : ""}
                                >
                                  2
                                </option>
                                <option
                                  value="3"
                                  selected={v.quantity == 3 ? "selected" : ""}
                                >
                                  3
                                </option>
                                <option
                                  value="4"
                                  selected={v.quantity == 4 ? "selected" : ""}
                                >
                                  4
                                </option>
                                <option
                                  value="5"
                                  selected={v.quantity == 5 ? "selected" : ""}
                                >
                                  5
                                </option>
                                <option
                                  value="6"
                                  selected={v.quantity == 7 ? "selected" : ""}
                                >
                                  6
                                </option>
                                <option
                                  value="7"
                                  selected={v.quantity == 8 ? "selected" : ""}
                                >
                                  7
                                </option>
                              </select>
            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-4">
              <div class="bg-light rounded-3 p-4 sticky-top">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div>Total</div>
                  <div>
                    <strong>Rs.{cartTotal + 100}</strong>
                  </div>
                </div>
